"""
Django settings for osita_43211 project.
...
WSGI_APPLICATION = 'osita_43211.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "osita_43211 API",
    "DESCRIPTION": "API documentation for osita_43211 App",
    "VERSION": "v1",
}
